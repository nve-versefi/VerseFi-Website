...
const logoStyles5 = [
    { maxWidth: '140px', height: 'auto' }, // TypeScript logo style
    { maxWidth: '190px', height: 'auto' }, // JavaScript logo style
    { maxWidth: '150px', height: 'auto' }, // TypeScript logo style
    { maxWidth: '190px', height: 'auto' }, // JavaScript logo style
    { maxWidth: '210px', height: 'auto' }, // TypeScript logo style
    { maxWidth: '320px', height: 'auto' }, // JavaScript logo style
    { maxWidth: '650px', height: 'auto' }, // TypeScript logo style
    { maxWidth: '3450px', height: 'auto' }, // TypeScript logo style
...
const calculateTotalWidth = () => logoStyles5.reduce((acc, style) => acc + parseInt(style.maxWidth, 10) + 2 * parseInt(imageMargin, 10), 0) * logoUrls5.length * 3; // Example: 3 times repetition
...
const startAutoMove = () => {
  ...
  return (
    <div className="text-center mb-5 px-">
  <h2 className="text-3xl font-bold text-blueribbon-500 mb-2 mt-9 underline">Supported Blockchains</h2>
  <p className="mb-4 mt-4 text-xl mx-12 text-aztec-700 font-medium">
  We support a variety of blockchain technologies, enabling tailored solutions for decentralized applications and smart contracts. Our expertise spans leading and emerging blockchains, focusing on secure, scalable platforms for our projects. We're also actively expanding our capabilities to include the Cosmos ecosystem, enhancing our offerings with its interoperable and scalable framework. This strategic expansion ensures we remain at the forefront of blockchain innovation, ready to meet diverse client needs.
  </p>
  <div
...
>
  ...
  {Array(5).fill(logoUrls5).flat().map((logoUrl, index) => {
    const itemStyle = { 
